...
export default function MarkdownView({ content, onLinkClick }: MarkdownViewProps) {
  ...
  const headingId = (children: React.ReactNode) => slugifyHeading(headingText(children));
        ...
        <article className="text-[var(--color-text-primary)] leading-7">
          <ReactMarkdown 
            ...
            components={{
              ...
              h1: ({node, children, ...props}) => <h1 id={headingId(children)} className="scroll-mt-8 text-3xl tracking-tight mb-8 font-bold text-[var(--color-text-primary)]" {...props}>{children}</h1>,
              h2: ({node, children, ...props}) => <h2 id={headingId(children)} className="scroll-mt-8 text-2xl tracking-tight mt-10 mb-5 border-b border-[var(--color-border-subtle)] pb-2 text-[var(--color-text-primary)]" {...props}>{children}</h2>,
              h3: ({node, children, ...props}) => <h3 id={headingId(children)} className="scroll-mt-8 text-xl tracking-tight mt-8 mb-4 font-semibold text-[var(--color-text-primary)]" {...props}>{children}</h3>,
